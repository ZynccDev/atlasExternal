...
inline json CreateConfig(std::string configName)
{
    ...
    j["ESP"] = 
    {
        ...
        { "Crosshair", Options::ESP::Crosshair },
        { "Health", Options::ESP::Health },
        { "Health Style", Options::ESP::HealthType},
        ...
        { "Crosshair Color", Options::ESP::CrosshairColor},
    ...
    j["Misc"] =
    {
        ...
        {"HitboxExpander", Options::HitboxExpander::Expand},
        {"Headless", Options::Misc::Headless},
        {"Fly", Options::Misc::Fly},
        {"FlySpeed", Options::Misc::FlySpeed},
    };

    j["Settings"] =
    {
        {"Menu Key", Options::MenuKey},
        {"Player List", Options::playerList},
        {"Watermark", Options::Misc::Watermark},
        {"Streamproof", Options::Misc::Streamproof},
    };
...
inline void LoadConfig(std::string configName)
{
    ...
    Options::ESP::Crosshair = data["ESP"]["Crosshair"];
    ...
    Options::ESP::CrosshairColor[0] = data["ESP"]["Crosshair Color"][0];
    Options::ESP::CrosshairColor[1] = data["ESP"]["Crosshair Color"][1];
    Options::ESP::CrosshairColor[2] = data["ESP"]["Crosshair Color"][2];
    ...
    Options::HitboxExpander::Expand = data["Misc"]["HitboxExpander"];
    Options::Misc::Headless = data["Misc"]["Headless"];
	Options::Misc::Fly = data["Misc"]["Fly"];
	Options::Misc::FlySpeed = data["Misc"]["FlySpeed"];

	// Settings Loading

	Options::MenuKey = data["Settings"]["Menu Key"];
    Options::playerList = data["Settings"]["Player List"];
    Options::Misc::Watermark = data["Settings"]["Watermark"];
    Options::Misc::Streamproof = data["Settings"]["Streamproof"];
