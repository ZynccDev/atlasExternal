...
inline void RunAimbot(ImDrawList* drawList)
{
    ...
    if (KeyBind::IsPressed(Options::Aimbot::AimbotKey, true) && Options::Aimbot::ToggleType == 1)
    {
        Options::Aimbot::Toggled = !Options::Aimbot::Toggled;
    }

    if (!KeyBind::IsPressed(Options::Aimbot::AimbotKey, false) && !Options::Aimbot::Toggled)
    {
